...
namespace SF\SmartfixBundle\Controller;
...
class SupportController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SmartfixBundle:Support')->findAll();

        return $this->render('SmartfixBundle:Support:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('SmartfixBundle:Support:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SmartfixBundle:Support')->find($id);
        ...
        return $this->render('SmartfixBundle:Support:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('SmartfixBundle:Support:edit.html.twig', array(
            'entity'      => $entity,
