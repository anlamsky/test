 ...
 */
class Subject extends \StudentBundle\Entity\Subject implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'StudentBundle\\Entity\\Subject' . "\0" . 'id', '' . "\0" . 'StudentBundle\\Entity\\Subject' . "\0" . 'name', '' . "\0" . 'StudentBundle\\Entity\\Subject' . "\0" . 'time', '' . "\0" . 'StudentBundle\\Entity\\Subject' . "\0" . 'student');
        }
