 ...
 */
class Role extends \StudentBundle\Entity\Role implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'StudentBundle\\Entity\\Role' . "\0" . 'id', '' . "\0" . 'StudentBundle\\Entity\\Role' . "\0" . 'name', '' . "\0" . 'StudentBundle\\Entity\\Role' . "\0" . 'role', '' . "\0" . 'StudentBundle\\Entity\\Role' . "\0" . 'users');
        }
     ...
     * {@inheritDoc}
     */
    public function addUser(\StudentBundle\Entity\User $users)
    {
     ...
     * {@inheritDoc}
     */
    public function removeUser(\StudentBundle\Entity\User $users)
    {
