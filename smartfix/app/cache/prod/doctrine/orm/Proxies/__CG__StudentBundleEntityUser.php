 ...
 */
class User extends \StudentBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'StudentBundle\\Entity\\User' . "\0" . 'username', '' . "\0" . 'StudentBundle\\Entity\\User' . "\0" . 'password', '' . "\0" . 'StudentBundle\\Entity\\User' . "\0" . 'email', '' . "\0" . 'StudentBundle\\Entity\\User' . "\0" . 'isActive', '' . "\0" . 'StudentBundle\\Entity\\User' . "\0" . 'id', '' . "\0" . 'StudentBundle\\Entity\\User' . "\0" . 'roles');
        }
